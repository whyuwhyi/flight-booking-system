...
LinkedList<ConnectingTicket> FlightNetwork::findConnectingFlights(const String& departureCity, const String& arrivalCity, const Date& date, int maxStops) const {
